...
/// A pure no-op [EmailRepository]; AccountSyncManager only drives sync, so no
/// method needs bespoke behaviour here.
class FakeEmailRepository extends FakeEmailRepositoryBase {}
