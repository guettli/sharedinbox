...
import de.sharedinbox.data.contacts.AndroidContactBookRepository
import de.sharedinbox.data.db.DriverFactory
import de.sharedinbox.data.db.SharedInboxDatabase
import de.sharedinbox.data.network.AndroidNetworkMonitor
...
actual fun platformModule(context: Any): Module =
    module {
        ...
        single<NetworkMonitor> { AndroidNetworkMonitor(context as Context) }
        single<ContactBookRepository> { AndroidContactBookRepository(context as Context) }
    }
