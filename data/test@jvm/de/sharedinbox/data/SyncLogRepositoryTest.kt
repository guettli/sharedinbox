...
class SyncLogRepositoryTest {
    ...
    @Test
    fun log_withDetail_preservesDetail() =
        runBlocking {
            repo.log(
                accountId = "acc1",
    ...
    @Test
    fun observeLogs_returnsNewestFirst() =
        runBlocking {
    ...
    @Test
    fun clearLogs_removesAllForAccount() =
        runBlocking {
            repo.log("acc1", SyncDirection.SERVER_TO_DB, "sync_mailboxes", SyncStatus.SUCCESS)
    ...
    @Test
    fun clearLogs_doesNotAffectOtherAccounts() =
        runBlocking {
            db.accountQueries.insertAccount(
                id = "acc2",
                display_name = "Other",
    ...
    @Test
    fun log_allDirections_roundTrip() =
        runBlocking {
            repo.log("acc1", SyncDirection.SERVER_TO_DB, "op", SyncStatus.SUCCESS)
